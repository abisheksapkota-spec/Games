...
js/
  ...
  config/
    ...
    worlds/
      forest/
        level1.js ... level5.js <- Forest world's 5 level configs. Same
                                     shape as the Dungeon files above.
    ...
    worlds.js                  <- THE WORLD REGISTRY. Combines the level
                                   ...
                                   soon" list, ready for future moods.
  ...
  game.js                      <- the biggest file: renders the maze,
                                   ...
                                   touch input. World-agnostic — it just
                                   asks "what's the active world's config"
                                   whenever it needs level data.
